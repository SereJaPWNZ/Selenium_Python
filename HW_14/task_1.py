...
try:
    ...
    wait.until(EC.element_to_be_clickable(email_field)).send_keys("m101serg@gmail.com")
    wait.until(EC.element_to_be_clickable(password_field)).send_keys("test1test")
    wait.until(EC.element_to_be_clickable(sign_in)).click()
    wait.until(EC.visibility_of_element_located(test))
